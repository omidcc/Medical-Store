    ...
    public partial class PurechaseBill : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmd.CommandText = "UPDATE Stock SET [Company-Name] ='" + comboBox2.Text + "', [Item-id] ='" + comboBox3.Text + "', [Purchase-QTY] ='" + q3 + "',[Available-QTY]='" + q5 + "' WHERE [Item-id] ='" + comboBox3.Text + "'";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "DELETE FROM Purchase WHERE [Bill-No]= '" + textBox1.Text + "' AND [Sr_No] = '" + textBox2.Text + "' AND [Model-Id]='" + comboBox3.Text + "'";
                    cmd.ExecuteNonQuery();
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "select [Bill-No],Date,[Party-Name],[Sr_No],[Company-Name],[Model-Id],Prize,Vat,Qty,[Total-vat],[Total-Prize] from Purchase Where [Bill-No]='" + int.Parse(textBox1.Text) + "'";
                SqlDataReader dar = cmd.ExecuteReader();
